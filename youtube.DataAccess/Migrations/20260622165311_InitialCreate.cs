    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Channals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Channals_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    AppUserId = table.Column<int>(type: "int", nullable: false),
                    ChannalId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubScription", x => new { x.AppUserId, x.ChannalId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_videos_Channals_ChannelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_likesDislikes", x => new { x.AppUserId, x.VideoId });
                    table.ForeignKey(
